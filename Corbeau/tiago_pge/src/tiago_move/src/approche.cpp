...
void ordreAptereRecallage_callback(const geometry_msgs::PoseStamped position_haut_pylon){
  ...
  tiago_arm.go_to_point_arm_tool_link(position_haut_pylon);
...
int main(int argc, char** argv)
{
  ...
  std::string frame_pylon = "pylon_fake"; // A METTRE EN PARAM
  double distanceFromPylon = 2.5; // A METTRE EN PARAM
  ...
  //Pour le test, lancer 
  // rostopic pub /aptere/approche/ordreRecalage geometry_msgs/PoseStamped '{header: {stamp: now, frame_id: "arm_tool_link"}, pose: {position: {x: 0.3 , y: 0.2, z: 0.1}, orientation: {w: 1.0}}}'
